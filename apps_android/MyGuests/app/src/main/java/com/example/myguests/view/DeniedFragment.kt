...
class DeniedFragment : Fragment() {
    ...
    private lateinit var deniedViewModel: AllGuestsViewModel
    ...
    override fun onCreateView(
        ...
        _listener = object : GuestListener {
            ...
            override fun onDelete(id: Int) {
                deniedViewModel.delete(id)
                deniedViewModel.loadAllGuestsList(GuestConstants.FILTER.DENIED)
            }
        }
    ...
    private fun observer() {
        deniedViewModel.allGuestsList.observe(viewLifecycleOwner, Observer {
